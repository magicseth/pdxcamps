...
function NavLink({
  ...
  return (
    <Link
      ...
      className={`relative flex flex-col items-center gap-1 py-3 px-4 min-h-[44px] rounded-lg transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 dark:focus-visible:ring-offset-slate-800 ${
        active
