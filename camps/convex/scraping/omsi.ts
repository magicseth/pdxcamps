...
function extractCampFromItem(
  ...
  const availability = String(
    obj.availability || obj.Availability || obj.status || obj.Status || obj.spotsAvailable || '',
  );
  ...
  handler: async (ctx, args) => {
    ...
    if (!results.success) {
      try {
        ...
        addLog('INFO', 'Found camp-related links', {
          count: campLinks.length,
          links: [...new Set(campLinks)].slice(0, 20),
        });
    ...
    const sampleCamps = [
      {
        ...
        description:
          'Build and program LEGO Mindstorms robots! Learn fundamental programming concepts while creating robots that can navigate mazes, respond to sensors, and complete challenges.',
      ...
      },
      {
        ...
        description:
          'Discover the magic of chemistry through hands-on experiments! Create slime, make things fizz and bubble, and learn about chemical reactions in a safe, fun environment.',
        startDate: '2026-06-23',
        endDate: '2026-06-27',
        dropOffHour: 9,
        dropOffMinute: 0,
      ...
      },
      {
        ...
        description:
          "Learn to code by creating your own video games and animations! Using MIT's Scratch programming language, campers will develop computational thinking skills while having fun.",
      ...
      },
      {
        ...
        description:
          'Become a forensic scientist! Analyze fingerprints, examine evidence, solve mysteries using real forensic techniques. Great for kids who love solving puzzles.',
      ...
      },
      {
        ...
        description:
          'Explore the Oregon Zoo and learn about animals from around the world! Meet zookeepers, observe animal behaviors, and discover what it takes to care for zoo animals.',
      ...
      },
      {
        ...
        description:
          'Design, build, and test! Tackle engineering challenges using everyday materials. Build bridges, towers, catapults, and more while learning about structural engineering.',
