        ...
        <div className="prose prose-slate dark:prose-invert max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-slate-600 dark:text-slate-400 mb-4">
              PDX Camps ("we," "our," or "us") operates the PDX Camps website and service at pdxcamps.com.
              This Privacy Policy explains how we collect, use, disclose, and safeguard your information
              when you use our service. We are committed to protecting your privacy and handling your data
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-slate-600 dark:text-slate-400 mb-4 space-y-2">
              <li><strong>Email address:</strong> Used to identify your account and send important notifications</li>
              <li><strong>Name:</strong> Used to personalize your experience</li>
              <li><strong>Profile picture:</strong> Displayed in the app interface (optional)</li>
            </ul>
            <p className="text-slate-600 dark:text-slate-400 mb-4">
              We only request basic profile information. We do not request access to your Google contacts,
              calendar, drive, or any other Google services.
            </p>
            ...
            <ul className="list-disc pl-6 text-slate-600 dark:text-slate-400 mb-4 space-y-2">
              <li><strong>Family information:</strong> Children's first names and birth years (used to show age-appropriate camps)</li>
              <li><strong>Camp preferences:</strong> Saved camps, registrations, and planning data</li>
              <li><strong>Family events:</strong> Vacations or events you add to your planner</li>
            </ul>
            ...
            <ul className="list-disc pl-6 text-slate-600 dark:text-slate-400 mb-4 space-y-2">
              ...
              <li><strong>IP address:</strong> Used for security and general location (city-level)</li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-slate-600 dark:text-slate-400 mb-4 space-y-2">
              <li><strong>Provide our service:</strong> Create your account, save your plans, show relevant camps</li>
              <li><strong>Personalize your experience:</strong> Show age-appropriate camps for your children</li>
              <li><strong>Process payments:</strong> Handle subscription billing through Stripe</li>
              <li><strong>Communicate with you:</strong> Send important account updates and respond to support requests</li>
            ...
            <p className="text-slate-600 dark:text-slate-400 mb-4">
              <strong>We do not use your data for advertising purposes.</strong> We do not sell, rent, or
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-slate-600 dark:text-slate-400 mb-4 space-y-2">
              <li>
                ...
                These providers only access data necessary to perform their services and are contractually
                obligated to protect your information.
              </li>
              <li><strong>With your consent:</strong> When you choose to share your summer plan with other families using our share feature</li>
          ...
          <section className="mb-8">
            ...
            <p className="text-slate-600 dark:text-slate-400 mb-4">
              <strong>You can delete your account at any time</strong> from your account settings page.
              Upon deletion, we will remove your personal data from our systems, except where retention
              is required by law.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-slate-600 dark:text-slate-400 mb-4 space-y-2">
              ...
              <li><strong>Revoke access:</strong> Disconnect Google sign-in from your Google account settings</li>
            </ul>
            <p className="text-slate-600 dark:text-slate-400 mb-4">
          ...
          <section className="mb-8">
            ...
            <p className="text-slate-600 dark:text-slate-400 mb-4">
              PDX Camps is designed for parents and guardians to plan summer activities for their children.
              We do not knowingly collect information directly from children under 13. The children's
              information we store (first names and birth years) is provided by parents/guardians for
              the purpose of showing age-appropriate camp recommendations.
            </p>
            <p className="text-slate-600 dark:text-slate-400 mb-4">
          ...
          <section className="mb-8">
            ...
            <p className="text-slate-600 dark:text-slate-400 mb-4">
              We may use analytics to understand how our service is used. You can control cookies
          ...
          <section className="mb-8">
            ...
            <p className="text-slate-600 dark:text-slate-400 mb-4">
              Your data may be processed on servers located in the United States. If you are located
